...
const AI = (() => {
  ...
  function learnerProfile() {
    try {
      ...
      const gradeMap = {
        '0':  'رياض الأطفال — استخدم لغة بسيطة جدًا وأمثلة محسوسة وألعابًا',
        '1':  'الصف الأول الابتدائي — لغة بسيطة جدًا وأمثلة ملموسة',
        ...
        '12': 'الصف الثالث الثانوي — يدرس التفاضل والتكامل',
